...
public class DeletedFrontendContentPageOem extends BaseTest {
	public static final Logger logger = LogManager.getLogger(DeletedFrontendContentPageOem.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void deleteFrontendOemContent() throws InterruptedException {
	...
	@Test(priority = 2,dependsOnMethods={"deleteFrontendOemContent"})
	public void deleteFrontendOemContent_1() {
	...
	@Test(priority = 2)
	public void deleteFrontendOemContent_2() {
				boolean actual = pages.verifySiteMapUrl();
				Utility.captureScreenshots(driver,"PageBuilder" ,"FrotnendDeleteContentPageOEM");
		Assert.assertEquals(actual, true, " Delted Content Page is not Loading  FrontEnd in OEM Level ");
	}

	@Test(priority = 3)
	public void deleteFrontendOemContent_3() {
