...
public class AddFrontendContentPageOem extends BaseTest {
	public static final Logger logger = LogManager.getLogger(AddFrontendContentPageOem.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void addFrontendOemContent() throws InterruptedException {
	...
	@Test(priority = 2)
	public void addFrontendOemContent_1() {
	...
	@Test(priority = 2)
	public void addFrontendOemContent_2() {
		CSVTableRow currentRow = csvData.get("FrontendOem");
			...
			Utility.captureScreenshots(driver,"PageBuilder" ,"FrontendAddContentPageOEM");
		Assert.assertEquals(actual, true, " Content Page is Loading  FrontEnd in OEM Level");
			}
	
	
	@Test(priority=3)
	public void addFrontendOemContent_3() {
