...
public class UpdatedFrontendCampPageOem extends BaseTest {
	public static final Logger logger = LogManager.getLogger(UpdatedFrontendCampPageOem.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority = 1)
	public void updateFrontendOemCampaign() throws InterruptedException {
	...
	@Test(priority = 2, dependsOnMethods = { "updateFrontendOemCampaign" })
	public void updateFrontendOemCampaign_1() {
	...
	@Test(priority = 2)
	public void updateFrontendOemCampaign_2() {
		CSVTableRow currentRow = csvData.get("FrontendUpdatedOem");
		...
		Utility.captureScreenshots(driver, "PageBuilder", "UpdatedFrontendCampaignPageOEM");
		Assert.assertEquals(actual, true, " Updated Campaign Page is Loading  FrontEnd in OEM Level ");
	}

	@Test(priority = 3)
	public void updateFrontendOemCampaign_3() {
