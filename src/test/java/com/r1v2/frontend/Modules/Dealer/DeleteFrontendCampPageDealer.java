...
public class DeleteFrontendCampPageDealer extends BaseTest {
	public static final Logger logger = LogManager.getLogger(DeleteFrontendCampPageDealer.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void deleteFrontendDlrCampaign() throws InterruptedException {
	...
	@Test(priority = 2,dependsOnMethods={"deleteFrontendDlrCampaign"})
	public void deleteFrontendDlrCampaign_1() {
	...
	@Test(priority = 2)
	public void deleteFrontendDlrCampaign_2() {
				boolean actual = pages.verifySiteMapUrl();
				Utility.captureScreenshots(driver,"PageBuilder" ,"FrontendDeleteContentPageDealer");
		Assert.assertEquals(actual, true, " Campaign  Page is Deleting  FrontEnd in Dealer Level ");
	}

	@Test(priority = 3)
	public void deleteFrontendDlrCampaign_3() {
