...
public class AddFrontendCampPageDealer extends BaseTest {
	public static final Logger logger = LogManager.getLogger(AddFrontendCampPageDealer.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void addFrontendDlrCampaign() throws InterruptedException {
	...
	@Test( priority=2,dependsOnMethods = { "addFrontendDlrCampaign" })
	public void addFrontendDlrCampaign_1() {
	...
	@Test(priority = 2)
	public void addFrontendDlrCampaign_2() {
		CSVTableRow currentRow = csvData.get("FrontendDlr");
		...
		Assert.assertEquals(actual, true, " Campaign Page is Loading on FrontEnd in Dealer Level ");
	}

	@Test(priority = 3)
	public void addFrontendDlrCampaign_3() {
