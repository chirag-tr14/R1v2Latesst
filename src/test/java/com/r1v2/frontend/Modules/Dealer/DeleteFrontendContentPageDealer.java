...
public class DeleteFrontendContentPageDealer extends BaseTest {
	public static final Logger logger = LogManager.getLogger(DeleteFrontendContentPageDealer.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void deleteFrontendDlrContent() throws InterruptedException {
	...
	@Test(priority = 2,dependsOnMethods={"deleteFrontendDlrContent"})
	public void deleteFrontendDlrContent_1() {
	...
	@Test(priority = 2)
	public void deleteFrontendDlrContent_2() {
				boolean actual = pages.verifySiteMapUrl();
				Utility.captureScreenshots(driver,"PageBuilder" ,"FrontendDeleteContentPageDealer");
		Assert.assertEquals(actual, true, " Deleted Page is not loading in frontend in Dealer Level ");
	}

	@Test(priority = 3)
	public void deleteFrontendDlrContent_3() {
