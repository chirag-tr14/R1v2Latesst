...
public class UpdatedFrontendCampPageGroup extends BaseTest {
	public static final Logger logger = LogManager.getLogger(UpdatedFrontendCampPageGroup.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void updateFrontendGrpCampign_1() throws InterruptedException {
	...
	@Test(priority = 2)
	public void updateFrontendGrpCampign_2() {
	...
	@Test(priority = 2)
	public void updateFrontendGrpCampign_3() {
		CSVTableRow currentRow = csvData.get("FrontendUpdatedGrp");
		...
		Assert.assertEquals(actual, true, " Updated Campaing  Page is Loading  FrontEnd in Group Level ");
	}

	@Test(priority = 3)
	public void updateFrontendGrpCampign_4() {
