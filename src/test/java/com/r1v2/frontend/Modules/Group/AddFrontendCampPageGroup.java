...
public class AddFrontendCampPageGroup extends BaseTest {
	public static final Logger logger = LogManager.getLogger(AddFrontendCampPageGroup.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority = 2,dependsOnMethods={"addFrontendGroupCampaign"})
	public void addFrontendGroupCampaign_1() {
		CSVTableRow currentRow = csvData.get("FrontendGrp");
		String dealerID = currentRow.getString("DealerId");
	...
	@Test(priority = 2)
	public void addFrontendGroupCampaign_2() {
		CSVTableRow currentRow = csvData.get("FrontendGrp");
		...
		pages.formsubmitButton(currentRow.getString("Title"));
		Utility.captureScreenshots(driver,"PageBuilder" ,"FrontendCampaignPagegroup");
		Assert.assertEquals(actual, true, " Campaign Page is Loading  FrontEnd in Dealer Level ");
	}

	@Test(priority = 3)
	public void addFrontendGroupCampaign_3() {
