...
public class DeletedFrontendContentpageGroup extends BaseTest {
	public static final Logger logger = LogManager.getLogger(DeletedFrontendContentpageGroup.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void deleteFrontendgroupContent() throws InterruptedException {
	...
	@Test(priority = 2,dependsOnMethods={"deleteFrontendgroupContent"})
	public void deleteFrontendGroupContent_1() {
	...
	@Test(priority = 3)
	public void deleteFrontendGroupContent_2() {
				boolean actual = pages.verifySiteMapUrl();
				Utility.captureScreenshots(driver,"PageBuilder" ,"FrontendDeleteContentPagegroup");
		Assert.assertEquals(actual, true, " Deleted Content Page is not Loading  FrontEnd  in Group Level");
	}

	@Test(priority = 4)
	public void deleteFrontendGroupContent_3() {
