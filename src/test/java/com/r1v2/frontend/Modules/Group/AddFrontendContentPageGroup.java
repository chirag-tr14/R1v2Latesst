...
public class AddFrontendContentPageGroup extends BaseTest {
	public static final Logger logger = LogManager.getLogger(AddFrontendContentPageGroup.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void addFrontendGrpContent() throws InterruptedException {
	...
	@Test(priority = 2,dependsOnMethods={"addFrontendGrpContent"})
	public void addFrontendGrpContent_1() {
	...
	@Test(priority = 2)
	public void addFrontendGrpContent_2() {
		CSVTableRow currentRow = csvData.get("FrontendGrp");
			boolean actual=	pages.veirfyFrontEndPageTitle(currentRow.getString("Title"));
			Utility.captureScreenshot(driver, "Front end ContentPage Group");
		Assert.assertEquals(actual, true, " Content Page is Loading  FrontEnd  in Dealer Level");
			}
	
	@Test(priority=3)
	public void addFrontendGrpContent_3() {
