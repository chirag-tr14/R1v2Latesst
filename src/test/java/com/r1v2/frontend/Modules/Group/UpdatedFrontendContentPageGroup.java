...
public class UpdatedFrontendContentPageGroup extends BaseTest {
	public static final Logger logger = LogManager.getLogger(UpdatedFrontendContentPageGroup.class);
	DataBase database;
	SCPages pages;
	...
	@Test(priority=1)
	public void updateFrontendGrpContent_1() throws InterruptedException {
	...
	@Test(priority = 2)
	public void updateFrontendGrpContent_2() {
	...
	@Test(priority = 2)
	public void updateFrontendGrpContent_3() {
		CSVTableRow currentRow = csvData.get("FrontendUpdatedGrp");
		...
		Utility.captureScreenshots(driver,"PageBuilder" ,"FrontendUpdateContentGroup");
		Assert.assertEquals(actual, true, " Updated Content Page is Loading  FrontEnd in Group Level");
	}

	@Test(priority = 3)
	public void updateFrontendGrpContent_4() {
