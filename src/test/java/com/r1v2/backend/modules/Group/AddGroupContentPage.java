...
public class AddGroupContentPage extends BaseTest {

	public static final Logger logger = LogManager.getLogger(AddGroupContentPage.class);
	SCPages scpages;
	...
	@BeforeClass
	public void addgroupContentPG_1() {
	...
	@Test(priority = 1)
	public void addgroupContentPG_2() {
	...
	@Test(priority = 2)
	public void addgroupContentPG_3() {
	...
	public void addgroupContentPG_5() {
		CSVTableRow currentRow = csvData.get("Group");
				...
				Assert.assertEquals(actual, true, " Title and Url  data  passing on Adding Content Page in Dealer Level ");
			}
	

	@Test(priority = 5)
	public void addgroupContentPG_6() {
		CSVTableRow currentRow = csvData.get("Group");
				boolean actual =
						scpages.verifyUrlPatternGroup(
								currentRow.getString("Url").concat(currentRow.getString("UrlPattern").trim()));
				Assert.assertEquals(actual, true, " Url pattern is not Matching as per local ");
			}
	

	@Test(priority = 6)
	public void addgroupContentPG_7() {
		CSVTableRow currentRow = csvData.get("Group");
	...
	@Test(priority = 7)
	public void addgroupContentPG_8() {
		boolean actual = scpages.clickThirdTabNextBtn();
				scpages.descriptionLinkButton();
		Assert.assertEquals(actual, true, " Description Button is Clickable ");
	}
	
	@Test(priority = 8)
	public void addgroupContentPG_9() {
		CSVTableRow currentRow = csvData.get("Group");
	...
	@Test(priority=9)
	public void addgroupContentPG_10() {
		CSVTableRow currentRow = csvData.get("Group");
					boolean actual= scpages.savePage()
	...
	@Test(priority=10)
		public void addgroupContentPG_11() {
