...
public class DeleteGroupContentPage extends BaseTest {
	public static final Logger logger = LogManager.getLogger(DeleteGroupContentPage.class);
	SCPages scpages;
	...
	@BeforeClass
	public void groupDeleteContentPage_1() {
	...
	@Test(priority = 1)
	public void groupDeleteContentPage_2() {
	...
	@Test(priority = 2)
	public void groupDeleteContentPage_3() {
			CSVTableRow currentRow = csvData.get("EditGroup");
				...
				Assert.assertEquals(actual, true, " Deleting Content Page in Group Level");
			}
	

	@Test(priority = 3)
	public void groupDeleteContentPage_4() {
