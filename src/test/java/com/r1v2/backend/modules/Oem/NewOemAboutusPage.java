...
public class NewOemAboutusPage extends BaseTest {

	public static final Logger logger = LogManager.getLogger(NewOemAboutusPage.class);
	SCPages scpages;
	...
	public void oemAboutusPG_8() {
		...
		while (itr.hasNext()) {
			...
			Utility.captureScreenshot(driver, "ContentPageSavedonOem");
		Assert.assertEquals(actual, true, " Content Page Save on Oem Level");
		}
	}
