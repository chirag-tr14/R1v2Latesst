...
public class DeleteOemCampaignPage extends BaseTest {
	public static final Logger logger = LogManager.getLogger(DeleteOemCampaignPage.class);
	SCPages scpages;
	...
	@BeforeClass
	public void oemDeleteCampPage_1() {
	...
	@Test(priority = 1)
	public void oemDeleteCampPage_2() {
	...
	@Test(priority = 2)
	public void oemDeleteCampPage_3() {
		...
		boolean actual = scpages.selectOrganization().selectOEM("@Value", currentRow.getString("DealerId"));
				...
				Assert.assertEquals(actual, true, " Deleting Campaign page in OEM Level  ");
			}
